...
class DiarioFragment : Fragment() {
    ...
    var recetas: MutableList<RecetaKt> = mutableListOf(
        ...
        RecetaKt("Macarrones", "71", "Esta de Italia x y lo hace todo el mundo porque es facil...", "20", "6 minutos", "3 comensales", 2),
        RecetaKt("Pizza 4 quesos", "4", "Esta receta viene de EEUU y ha ganado mucha popularidad porque y lo han vendido muy bien por todo el mundo, no toma mucho tiempo y esta muy buena. Creemos que te podria encantar. muchos animos...", "20", "15 minutos", "5 comensales", 2),
        ...
        RecetaKt("Paella", "Paso 1", "Reseta clasica de España que deberia probar todo el mundo. Tomara mucho tiempo", "20", "80 minutos", "8 comensales", 1),
